  ...
  jQuery.extend(!0, _R, {
    ...
    enterInViewPort: function (a) {
      a.waitForCountDown && (countDown(a.c, a), (a.waitForCountDown = !1)),
        a.waitForFirstSlide && (swapSlide(a.c), (a.waitForFirstSlide = !1)),
    ...
    swaptoggleState: function (a) {
      a != undefined &&
        a.length > 0 &&
        jQuery.each(a, function (a, b) {
          b.hasClass("rs-toggle-content-active")
            ? b.removeClass("rs-toggle-content-active")
            : b.addClass("rs-toggle-content-active");
        });
    },
          ...
          a.find(".tp-caption, .rs-background-video-layer").each(function (a) {
            ...
            if (
              (c.find("iframe").each(function () {
                punchgs.TweenLite.set(jQuery(this), { autoAlpha: 0 }), j++;
              }),
              j > 0 && c.data("iframes", !0),
              c.hasClass("tp-caption"))
            ) {
              var k = c.hasClass("slidelink")
            ...
            u !== undefined && _R.checkActions(c, b, u),
      ...
      a.parent().css({ overflow: "visible" }),
        b.allli.find(">img").each(function (a) {
          ...
          (f = "none" === f || f === undefined ? "" : f),
            c.wrap(
              '<div class="slotholder ' +
                f +
                '" style="position:absolute; top:0px; left:0px; z-index:0;width:100%;height:100%;"></div>'
            ),
          ...
          (g.src = h),
            ...
            //   bgSize = "120% 200%"; // set background size to 212% 100%
            // }
